    ...
    require("catppuccin").setup({
      ...
      custom_highlights = function(colors)
        return {
          ...
          -- Glance
          GlanceWinbarFilepath = { fg = colors.text, bg = colors.mantle },
          GlanceWinbarFilename = { fg = colors.text, bg = colors.mantle },
          GlanceWinbarTitle = { fg = colors.text, bg = colors.mantle },
